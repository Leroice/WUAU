...
// ─── TRANSACTIONS ─────────────────────────────────────────────────────────────
export const TRANSACTIONS: HomeTransaction[] = [
  {
    initials: 'JL',
    name: 'Jessie Lai Lai',
...
export const PAYMENTS_CONTACTS: PaymentContact[] = [
...
export const PAYMENTS_UPCOMING: UpcomingPayment[] = [
...
export const PAYMENTS_RECENT: RecentPayment[] = [
...
export const CARD_SPENDS: CardSpend[] = [
  {
    merchant: 'Uniqlo',
